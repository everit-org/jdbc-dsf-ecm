...
import org.everit.persistence.jdbc.dsf.ecm.AttributePriority;
...
@StringAttributes({
    @StringAttribute(attributeId = DataSourceFactory.JDBC_URL,
        priority = AttributePriority.P02_JDBC_URL, label = "Jdbc URL",
    ...
    @StringAttribute(attributeId = DataSourceFactory.JDBC_NETWORK_PROTOCOL,
        priority = AttributePriority.P03_JDBC_NETWORK_PROTOCOL, defaultValue = "",
    ...
    @StringAttribute(attributeId = DataSourceFactory.JDBC_SERVER_NAME,
        priority = AttributePriority.P04_JDBC_SERVER_NAME, defaultValue = "", label = "Server name",
    ...
    @StringAttribute(attributeId = DataSourceFactory.JDBC_PORT_NUMBER,
        priority = AttributePriority.P05_JDBC_PORT_NUMBER, defaultValue = "", label = "Port",
    ...
    @StringAttribute(attributeId = DataSourceFactory.JDBC_DATABASE_NAME,
        priority = AttributePriority.P06_JDBC_DATABASE_NAME, defaultValue = "",
        label = "Database name",
    ...
    @StringAttribute(attributeId = DataSourceFactory.JDBC_USER,
        priority = AttributePriority.P07_JDBC_USER, defaultValue = "", label = "User name",
    ...
    @StringAttribute(attributeId = DataSourceFactory.JDBC_DATASOURCE_NAME,
        priority = AttributePriority.P09_JDBC_DATASOURCE_NAME, defaultValue = "",
        label = "DataSource name",
        description = "Name of the data source."),
    @StringAttribute(attributeId = DataSourceFactory.JDBC_DESCRIPTION,
        priority = AttributePriority.P10_JDBC_DESCRIPTION, defaultValue = "",
        label = "DataSource description",
        description = "Description of the data source."),
    @StringAttribute(attributeId = DataSourceFactory.JDBC_ROLE_NAME,
        priority = AttributePriority.P17_JDBC_ROLE_NAME, defaultValue = "", label = "Role name",
    ...
    @StringAttribute(attributeId = DSFConstants.ATTR_CUSTOM_PROPERTIES, defaultValue = "",
        multiple = ThreeStateBoolean.TRUE, priority = AttributePriority.P18_CUSTOM_PROPERTIES,
...
@PasswordAttributes({
    @PasswordAttribute(attributeId = DataSourceFactory.JDBC_PASSWORD, defaultValue = "",
        priority = AttributePriority.P08_JDBC_PASSWORD, label = "Password",
...
@IntegerAttributes({
    @IntegerAttribute(attributeId = DSFUtil.ATTR_LOGIN_TIMEOUT, defaultValue = 0,
        priority = AttributePriority.P19_LOGIN_TIMEOUT, label = "Login timeout",
...
public abstract class AbstractDataSource {
  ...
  @ServiceRef(defaultValue = "", attributePriority = AttributePriority.P01_DATA_SOURCE_FACTORY,
  ...
  @ServiceRef(defaultValue = "", attributePriority = AttributePriority.P20_LOG_SERVICE,
